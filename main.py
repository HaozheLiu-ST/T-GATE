...
if __name__ == '__main__':
    ...
    if args.model in ['sd_2.1', 'sd_1.5']:
        ...
        cfg_register_custom_forward(pipe.unet, 'Attention', gate_step=args.gate_step,
                                    inference_num_per_image=args.inference_step)
        pipe = pipe.to("cuda")
        ...
        cfg_register_custom_forward(pipeline_text2image.unet, 'Attention', gate_step=args.gate_step,
                                    inference_num_per_image=args.inference_step)
        ...
        cfg_register_custom_forward(pipe.transformer, 'Attention', gate_step=args.gate_step,
                                    inference_num_per_image=args.inference_step)
        pipe = pipe.to("cuda")
        image = pipe.tgate(args.prompt,
                           gate_step=args.gate_step,
        ...
        lcm_register_custom_forward(pipe.transformer, 'Attention', gate_step=args.gate_step,
                                    inference_num_per_image=args.inference_step)
        pipe = pipe.to("cuda")
        ...
        lcm_register_custom_forward(pipe.unet, 'Attention', gate_step=args.gate_step,
                                    inference_num_per_image=args.inference_step)
